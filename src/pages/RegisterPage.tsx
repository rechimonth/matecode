    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Creá tu cuenta y empezá a organizar tus tareas</p>
        </div>
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input className="input" type="password" value={confirmPassword} onChange={(e) => { setConfirmPassword(e.target.value); setLocalError(null); }} />
            </div>
